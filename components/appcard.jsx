  ...
  render : function() {
    ...
    return (
      <div className={styles1.card}>
          <div className={styles1.viewDetail}>
              <div className={styles1.icon}>
                  <img src={this.props.icon || this.state.icon} alt={this.props.title || this.state.title} />
              </div>
              <div className={styles1.title}>{this.props.title || this.state.title}</div>
          </div>
          <div className={styles1.description} dangerouslySetInnerHTML={{__html: desc}}/>
          <a href="#" onClick={this.handleClick} className={styles1.install + ' ' + styles1.button}><span className={styles1.iconBtn}></span><span>{this.getInstallStateText()}</span></a>
      </div>
    );
  }
});